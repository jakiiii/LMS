...
stripe.api_key = "sk_test_51H57IJJxOEjGpot0g90FYUAtdF0QLzCIGZhNZ85v3yuS3zE6VbBknxbPinCsSENcGjlRglOIUIVtv5ABCzeyz0co009B28MhA0"
...
class BillingProfile(models.Model):
    ...
    def default_card(self):
        default_card = self.get_card().filter(active=True, default=True)
